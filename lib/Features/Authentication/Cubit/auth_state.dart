...
class VerifyOtpAtForgetPasswordLoadingState extends AuthState {}

class VerifyOtpAtForgetPasswordErrorState extends AuthState {}

class VerifyOtpAtForgetPasswordSuccessState extends AuthState {
  final String token;
